...
int main(int argc, char** argv) {
    ...
    string path = "/home/scott/Arctria/ARC-34 Yogi/v00/";
    ExampleChemicalData exChemicalData("/home/scott/Arctria/ARC-34 Yogi/data/ToxCast_MM_Data/ToxRefDB_Challenge_Training.csv");
    DSSToxData exDSSToxData("/home/scott/Arctria/ARC-34 Yogi/data/DSSTox/csv/TOX21S_v4a_8599_11Dec2013.csv");
    ToxCastData exToxCastData("/home/scott/Arctria/ARC-34 Yogi/data/DSSTox/csv/toxprint_v2_vs_TOX21S_v4a_8599_03Dec2013.csv"); 
    ...
    for (int i = 1; i < argc; ++i) {
        ...
        if ((arg == "-t") || (arg == "--training")) {
            ...
            double NN_cycle_stop = NN_cycle_start + (300*1000000.0);
