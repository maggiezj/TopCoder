/* ChildStuntedness v36 [Competition Sensitive]
 * TopCoder
...
vector<double> ChildStuntedness::generateResult(vector<_result> resultVector) {
    ...
    for (int i = 0; i < resultVector.size(); i++) {
        longIDList.push_back(resultVector.at(i).ID);
    }

    IDList = A.unique(longIDList);
    cout << "Size of ID List (from A.unique method): " << IDList.size() << endl;
    ...
    cout << "Size of IDList: " << IDList.size() << endl;*/
