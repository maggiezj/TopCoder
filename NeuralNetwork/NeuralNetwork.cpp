...
int main()
{
    ...
    for (int trainingPass = 0; trainingPass < 1000; trainingPass++) {
        cout << "training pass: " << trainingPass << " avg error: " << myNet.getRecentAverageError() << endl;
        for (int i = 0; i < output.size(); i++) {
            inputVals.clear();
            targetVals.clear();
            
            inputVals.push_back(input1.at(i));
            inputVals.push_back(input2.at(i));
            targetVals.push_back(output.at(i));
