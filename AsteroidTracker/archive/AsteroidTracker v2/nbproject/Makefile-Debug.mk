...
${OBJECTDIR}/AsteroidTracker.o: AsteroidTracker.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AsteroidTracker.o AsteroidTracker.cpp
